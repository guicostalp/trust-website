...
<html lang="en">
<head>
    <title>Code coverage report for src/commit-per-line.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/commit-per-line.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; commit-per-line.js</div>
</div>
<div class="body">
...
&nbsp;
function toArray(x) {
  return Array.isArray(x) ? x : <span class="branch-1 cbranch-no" title="branch not covered" >[x];</span>
}
&nbsp;
