...
<html lang="en">
<head>
    <title>Code coverage report for ggit/test/blame.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">ggit/test/blame.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">ggit/test/</a> &#187; blame.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var blame = require('../index').blame;
require('lazy-ass');
...
<span class="cstat-no" title="statement not covered" >    la(check.unemptyString(err) || check.unemptyString(err.message), 'error is a message');</span>
<span class="cstat-no" title="statement not covered" >    gt.ok(false, err);</span>
  }).finally(function () {
    gt.start();
  }).done();
});
