...
<html lang="en">
<head>
    <title>Code coverage report for ggit/index.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">ggit/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">ggit/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var getOneLineLog = require('./src/get-one-line-log');
&nbsp;
module.exports = {
...
<span class="cstat-no" title="statement not covered" >	getOneLineLog({</span>
		n: 4,
		remote: 'origin',
		branch: 'master'
	})
	.done(<span class="fstat-no" title="function not covered" >function (stdout) {</span>
