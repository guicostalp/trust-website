...
<html lang="en">
<head>
    <title>Code coverage report for ggit/src/tracked-source-files.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">ggit/src/tracked-source-files.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">ggit/src/</a> &#187; tracked-source-files.js</div>
</div>
<div class="body">
...
function sourceFiles(folderName, pattern) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (folderName) {
    return folder.to(folderName)
      .then(findFiles.bind(null, pattern))
      .then(leaveTracked)
      .tap(folder.back);
  }
<span class="cstat-no" title="statement not covered" >  return findFiles(pattern)</span>
    .then(leaveTracked);
}
&nbsp;
